...
const CardLinkTitle = ({cardStyle = 'card shadow', children, info, height, width,  native = 'mx-2 mb-2', objectFit, divStyle = 'flex-col-center'}) => {
  return(
    <>
      <div className={divStyle}> 
        <div className={`${cardStyle}`}> 
          <ImageProfile siteUrl={info.image.large} height={height} width={width} objectFit={objectFit} />
